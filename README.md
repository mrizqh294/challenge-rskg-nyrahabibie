...
Pengguna dapat login menggunakan akun yang telah tersedia pada database.

Hak akses pengguna akan disesuaikan berdasarkan role:
...
Setiap role memiliki halaman dan hak akses yang berbeda sesuai dengan kebutuhan sistem.

---
# Catatan

Untuk menjalankan project dari kondisi awal, pastikan:

1. MySQL sudah berjalan.
2. Database sudah dibuat.
3. File `.env` sudah dikonfigurasi.
4. Dependency sudah diinstall menggunakan `npm install`.
5. Prisma Client sudah di-generate.
6. Migration sudah dijalankan.
7. Seeder sudah dijalankan.
8. Development server sudah dijalankan menggunakan `npm run dev`.