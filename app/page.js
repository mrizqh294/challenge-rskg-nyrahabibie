...
export default function LoginSIMRS() {
    ...
    <div className="h-screen w-screen flex flex-col justify-center items-center bg-[#F8FAFC] text-[#0b1c30] font-sans relative">
      <main className="w-full max-w-md px-4 md:px-0 flex flex-col items-center m-0">
        ...
        <div className="mb-6 flex flex-col items-center">
          <h1 className="text-[32px] leading-[40px] tracking-[-0.02em] font-bold text-[#006194] text-center">
            SIMRS
          </h1>
          <p className="text-sm text-[#3f4850] mt-1 text-center">
            Portal SIMRS
          </p>
        </div>
        ...
        <div className="w-full rounded-xl p-8 bg-white border border-[#E2E8F0] shadow-[0_10px_20px_rgba(0,0,0,0.1)]">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-semibold text-white bg-[#0284C7] hover:bg-[#007bb9] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#006194] transition-colors mt-4"
            >
              Login
            </button>
          </form>
